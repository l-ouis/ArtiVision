...
class YourModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.architecture = [
              ...
              Conv2D(32, 3, 1, activation='relu', padding='same', input_shape=(hp.img_size, hp.img_size, 3)),
              BatchNormalization(),
              MaxPool2D(2),
...
class VGGModel(tf.keras.Model):
    def __init__(self):
        ...
        self.head = [Flatten(), Dense(512, activation="relu"), Dense(15, activation="softmax")]
